...
namespace Game.Networking.Adapters
{
    ...
    public partial class PlayerNetworkDriverFishNet : NetworkBehaviour, IPlayerNetworkDriver
    {
        ...
        public ElevationPolicyMode elevationPolicy = ElevationPolicyMode.GroundSnap;
        ...
        private IElevationPolicy _elevationPolicy;
        private bool _servicesResolved;
    
        private uint _lastSeqSent, _lastSeqReceived;

        private readonly PlayerDriverRemoteState _remoteState = new();
        ...
        private readonly List<NetworkConnection> _serverRetryScratch = new();
        private readonly List<ShardInfo> _fecRecoveryScratch = new();
